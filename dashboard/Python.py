...
day_df = pd.read_csv("https://raw.githubusercontent.com/EBay12Y/submission-proyek-analisis-data/main/data/day.csv")
day_df.head()
...
st.caption('Copyright (c) Eka Bayu Satriawan 2023')
